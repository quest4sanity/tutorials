...
public class PrioritiesMapperTest {
	...
	public static void setUpBeforeClass() throws Exception {
		String resource = "mybatis-dynsql-config.xml";
	...
	public void testPriorities() {
		...
		Optional<Priorities> priorities = PrioritiesMapper.selectByPrimaryKey(2L);
		
		assertTrue(priorities.isPresent());
		assertEquals("MAJOR", priorities.get().getCode());
		assertEquals("Major", priorities.get().getTitle());
	}
